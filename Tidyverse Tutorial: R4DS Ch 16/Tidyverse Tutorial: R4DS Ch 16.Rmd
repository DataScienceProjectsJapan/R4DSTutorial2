...
Create a new function “make_datetime_new” to break the times into hours and minutes. Use modulus arithmetic to pull out the hour and minute components from columns of “dep_time” and “sched_dep_time”. Visualize the distribution of scheduled departure time (sched_dep_time) within one week (from January 1, 2013 to January 7, 2013), with a binwidth of 1 hour.
