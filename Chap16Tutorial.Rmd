...
Write the code to create a column for the departure time data (year, month, date) in date format. Name the column "departure_date".
...
Write the code to create a column for the departure time data (year, month, date, dep_time) in date_time format. Name the column "departure_time".
...
Make a graph to show the distribution of flight departure time on January 01, 2013 using R code. Use 10 minutes as the frequency.
